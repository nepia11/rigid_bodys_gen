...
class RBG_PT_MenuSoftEngine(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.operator(
            RBG_OT_ExeSoftEngine.bl_idname, text="Execute Soft Engine", icon="PLAY"
        )
...
class RBG_OT_ExeSoftEngine(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for v in vlist:
            ...
            co = (
                obamt[0]
                .pose.bones["softbone." + str(v.index)]
                .constraints.new("CHILD_OF")
            )
        ...
        for e in elist:
            ...
            jc = bpy.ops.object.empty_add(
                type="PLAIN_AXES", radius=0.1, align="WORLD", location=wmid
            )
            ...
            jc.rigid_body_constraint.object1 = bpy.data.objects[
                "rc." + str(e.verts[0].index)
            ]
            jc.rigid_body_constraint.object2 = bpy.data.objects[
                "rc." + str(e.verts[1].index)
            ]
...
classes = [RBG_PT_MenuSoftEngine, RBG_OT_ExeSoftEngine]
